...
static int math_sin (lua_State *L) {
  lua_pushnumber(L, streflop_sin(luaL_checknumber(L, 1)));
  return 1;
}

static int math_sinh (lua_State *L) {
  lua_pushnumber(L, streflop_sinh(luaL_checknumber(L, 1)));
  return 1;
}

static int math_cos (lua_State *L) {
  lua_pushnumber(L, streflop_cos(luaL_checknumber(L, 1)));
  return 1;
}

static int math_cosh (lua_State *L) {
  lua_pushnumber(L, streflop_cosh(luaL_checknumber(L, 1)));
  return 1;
}

static int math_tan (lua_State *L) {
  lua_pushnumber(L, streflop_tan(luaL_checknumber(L, 1)));
  return 1;
}

static int math_tanh (lua_State *L) {
  lua_pushnumber(L, streflop_tanh(luaL_checknumber(L, 1)));
  return 1;
}

static int math_asin (lua_State *L) {
  lua_pushnumber(L, streflop_asin(luaL_checknumber(L, 1)));
  return 1;
}

static int math_acos (lua_State *L) {
  lua_pushnumber(L, streflop_acos(luaL_checknumber(L, 1)));
  return 1;
}

static int math_atan (lua_State *L) {
  lua_pushnumber(L, streflop_atan(luaL_checknumber(L, 1)));
  return 1;
}

static int math_atan2 (lua_State *L) {
  lua_pushnumber(L, streflop_atan2(luaL_checknumber(L, 1), luaL_checknumber(L, 2)));
  return 1;
}
...
//  double ip;
//  double fp = streflop_modf(luaL_checknumber(L, 1), &ip);
//  lua_pushnumber(L, ip);
//  lua_pushnumber(L, fp);
//  return 2;
//}
...
static int math_random (lua_State *L) {
  ...
  switch (lua_gettop(L)) {  /* check number of arguments */
    ...
    case 1: {  /* only upper limit */
      ...
      lua_pushnumber(L, streflop_floor(r*u)+1);  /* int between 1 and `u' */
      break;
    }
    case 2: {  /* lower and upper limits */
      ...
      lua_pushnumber(L, streflop_floor(r*(u-l+1))+l);  /* int between `l' and `u' */
      break;
    }
