...
namespace CSharpAI
{
    // baseclass for ContructorController and FactoryController
    public class Builder : IController, IFactoryController
    {
        ...
        void BuildSomething( int factoryid )
        {
            ...
            if( requestertosatisfy != null )
            {
                ...
                logfile.WriteLine( "builder " + factoryid + " going with request from " + requestertosatisfy.ToString() + " for " + unitdef.humanName );
        ...
        public void UnitIdle( int unitid )
        {
            if( FactoryUnitDefByDeployedId.Contains( unitid ) )
            {
                logfile.WriteLine( "Builder " + unitid.ToString() + " on idle" );
                BuildSomething( unitid );
            }
        }
