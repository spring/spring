...
namespace CSharpAI
{
    ...
    public class FactoryController : IController, IFactoryController, IUnitRequester
    {
        ...
        {
            if( factory.Name == BuildTable.ArmCommander || factory.Name == BuildTable.ArmConstructionVehicle || factory.Name == "armck" )
            {
...
//                }
               ...
               // else
                {
                    factorydef = buildtable.UnitDefByName[ BuildTable.ArmVehicleFactory ] as IUnitDef;
                }
            }
            else
            {
