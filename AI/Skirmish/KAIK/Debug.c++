...
void CDebug::MakeBWTGA(int* array, int xsize, int ysize, std::string filename, float curve) {
...
void CDebug::MakeBWTGA(float* array, int xsize, int ysize, std::string filename, float curve) {
	int totalsize = xsize * ysize;
	float* TGAArray = new float[totalsize];
...
void CDebug::MakeBWTGA(unsigned char* array, int xsize, int ysize, std::string filename, float curve) {
	int totalsize = xsize * ysize;
	float* TGAArray = new float[totalsize];
...
void CDebug::MakeBWTGA(bool* array, int xsize, int ysize, std::string filename, float curve) {
	curve = 1;
	int totalsize = xsize * ysize;
	float* TGAArray = new float[totalsize];
...
void CDebug::OutputBWTGA(float* array, int xsize, int ysize, std::string filename, float curve) {
	float topvalue = 0;
	int totalsize = xsize * ysize;
	...
	std::string fullpath = std::string(TGAFOLDER) + filename + ".tga";
