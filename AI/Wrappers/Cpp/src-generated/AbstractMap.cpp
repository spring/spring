...
#include "IncludesSources.h"
	...
	springai::AbstractMap::~AbstractMap() {}
	int springai::AbstractMap::CompareTo(const Map& other) {
		static const int EQUAL  =  0;
		static const int BEFORE = -1;
		static const int AFTER  =  1;

		if ((Map*)this == &other) return EQUAL;
...
bool springai::AbstractMap::Equals(const Map& other) {

	if (this->GetSkirmishAIId() != other.GetSkirmishAIId()) return false;
	return true;
}

int springai::AbstractMap::HashCode() {
...
std::string springai::AbstractMap::ToString() {

	std::string internal_ret = "Map";
