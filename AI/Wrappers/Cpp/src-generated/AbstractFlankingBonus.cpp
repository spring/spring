...
#include "AbstractFlankingBonus.h"

#include "IncludesSources.h"

	springai::AbstractFlankingBonus::~AbstractFlankingBonus() {}
	int springai::AbstractFlankingBonus::CompareTo(const FlankingBonus& other) {
		static const int EQUAL  =  0;
		static const int BEFORE = -1;
		static const int AFTER  =  1;

		if ((FlankingBonus*)this == &other) return EQUAL;
...
bool springai::AbstractFlankingBonus::Equals(const FlankingBonus& other) {
...
int springai::AbstractFlankingBonus::HashCode() {
...
std::string springai::AbstractFlankingBonus::ToString() {

	std::string internal_ret = "FlankingBonus";
