...
#include "IncludesSources.h"
	...
	springai::AbstractLog::~AbstractLog() {}
	int springai::AbstractLog::CompareTo(const Log& other) {
		static const int EQUAL  =  0;
		static const int BEFORE = -1;
		static const int AFTER  =  1;

		if ((Log*)this == &other) return EQUAL;
...
bool springai::AbstractLog::Equals(const Log& other) {

	if (this->GetSkirmishAIId() != other.GetSkirmishAIId()) return false;
	return true;
}

int springai::AbstractLog::HashCode() {
...
std::string springai::AbstractLog::ToString() {

	std::string internal_ret = "Log";
