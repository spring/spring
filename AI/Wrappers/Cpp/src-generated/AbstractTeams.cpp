...
#include "AbstractTeams.h"

#include "IncludesSources.h"

	springai::AbstractTeams::~AbstractTeams() {}
	int springai::AbstractTeams::CompareTo(const Teams& other) {
		static const int EQUAL  =  0;
		static const int BEFORE = -1;
		static const int AFTER  =  1;

		if ((Teams*)this == &other) return EQUAL;
...
bool springai::AbstractTeams::Equals(const Teams& other) {

	if (this->GetSkirmishAIId() != other.GetSkirmishAIId()) return false;
	return true;
}

int springai::AbstractTeams::HashCode() {
...
std::string springai::AbstractTeams::ToString() {

	std::string internal_ret = "Teams";
