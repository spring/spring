...
#include "AbstractGraphLine.h"

#include "IncludesSources.h"

	springai::AbstractGraphLine::~AbstractGraphLine() {}
	int springai::AbstractGraphLine::CompareTo(const GraphLine& other) {
		static const int EQUAL  =  0;
		static const int BEFORE = -1;
		static const int AFTER  =  1;

		if ((GraphLine*)this == &other) return EQUAL;
...
bool springai::AbstractGraphLine::Equals(const GraphLine& other) {

	if (this->GetSkirmishAIId() != other.GetSkirmishAIId()) return false;
	return true;
}

int springai::AbstractGraphLine::HashCode() {
...
std::string springai::AbstractGraphLine::ToString() {

	std::string internal_ret = "GraphLine";
