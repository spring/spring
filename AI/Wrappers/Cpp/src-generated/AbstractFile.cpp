...
#include "IncludesSources.h"
	...
	springai::AbstractFile::~AbstractFile() {}
	int springai::AbstractFile::CompareTo(const File& other) {
		static const int EQUAL  =  0;
		static const int BEFORE = -1;
		static const int AFTER  =  1;

		if ((File*)this == &other) return EQUAL;
...
bool springai::AbstractFile::Equals(const File& other) {

	if (this->GetSkirmishAIId() != other.GetSkirmishAIId()) return false;
	return true;
}

int springai::AbstractFile::HashCode() {
...
std::string springai::AbstractFile::ToString() {

	std::string internal_ret = "File";
