...
#include "AbstractMod.h"

#include "IncludesSources.h"

	springai::AbstractMod::~AbstractMod() {}
	int springai::AbstractMod::CompareTo(const Mod& other) {
		static const int EQUAL  =  0;
		static const int BEFORE = -1;
		static const int AFTER  =  1;

		if ((Mod*)this == &other) return EQUAL;
...
bool springai::AbstractMod::Equals(const Mod& other) {

	if (this->GetSkirmishAIId() != other.GetSkirmishAIId()) return false;
	return true;
}

int springai::AbstractMod::HashCode() {
...
std::string springai::AbstractMod::ToString() {

	std::string internal_ret = "Mod";
