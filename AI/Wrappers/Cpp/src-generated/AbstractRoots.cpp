...
#include "AbstractRoots.h"

#include "IncludesSources.h"

	springai::AbstractRoots::~AbstractRoots() {}
	int springai::AbstractRoots::CompareTo(const Roots& other) {
		static const int EQUAL  =  0;
		static const int BEFORE = -1;
		static const int AFTER  =  1;

		if ((Roots*)this == &other) return EQUAL;
...
bool springai::AbstractRoots::Equals(const Roots& other) {

	if (this->GetSkirmishAIId() != other.GetSkirmishAIId()) return false;
	return true;
}

int springai::AbstractRoots::HashCode() {
...
std::string springai::AbstractRoots::ToString() {

	std::string internal_ret = "Roots";
