...
#include "IncludesSources.h"
	...
	springai::AbstractInfo::~AbstractInfo() {}
	int springai::AbstractInfo::CompareTo(const Info& other) {
		static const int EQUAL  =  0;
		static const int BEFORE = -1;
		static const int AFTER  =  1;

		if ((Info*)this == &other) return EQUAL;
...
bool springai::AbstractInfo::Equals(const Info& other) {

	if (this->GetSkirmishAIId() != other.GetSkirmishAIId()) return false;
	return true;
}

int springai::AbstractInfo::HashCode() {
...
std::string springai::AbstractInfo::ToString() {

	std::string internal_ret = "Info";
