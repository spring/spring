...
#include "AbstractShield.h"

#include "IncludesSources.h"

	springai::AbstractShield::~AbstractShield() {}
	int springai::AbstractShield::CompareTo(const Shield& other) {
		static const int EQUAL  =  0;
		static const int BEFORE = -1;
		static const int AFTER  =  1;

		if ((Shield*)this == &other) return EQUAL;
...
bool springai::AbstractShield::Equals(const Shield& other) {
...
int springai::AbstractShield::HashCode() {
...
std::string springai::AbstractShield::ToString() {

	std::string internal_ret = "Shield";
