...
unitDef->canSelfD = sAICallback->Clb_UnitDef_isCanSelfD(teamId, unitDefId);
unitDef->selfDCountdown = sAICallback->Clb_UnitDef_getSelfDCountdown(teamId, unitDefId);
unitDef->canSubmerge = sAICallback->Clb_UnitDef_isCanSubmerge(teamId, unitDefId);
unitDef->canfly = sAICallback->Clb_UnitDef_isCanFly(teamId, unitDefId);
unitDef->canmove = sAICallback->Clb_UnitDef_isCanMove(teamId, unitDefId);
unitDef->canhover = sAICallback->Clb_UnitDef_isCanHover(teamId, unitDefId);
...
unitDef->canRestore = sAICallback->Clb_UnitDef_isCanRestore(teamId, unitDefId);
unitDef->canRepair = sAICallback->Clb_UnitDef_isCanRepair(teamId, unitDefId);
unitDef->canSelfRepair = sAICallback->Clb_UnitDef_isCanSelfRepair(teamId, unitDefId);
unitDef->canReclaim = sAICallback->Clb_UnitDef_isCanReclaim(teamId, unitDefId);
unitDef->canAttack = sAICallback->Clb_UnitDef_isCanAttack(teamId, unitDefId);
unitDef->canPatrol = sAICallback->Clb_UnitDef_isCanPatrol(teamId, unitDefId);
unitDef->canFight = sAICallback->Clb_UnitDef_isCanFight(teamId, unitDefId);
unitDef->canGuard = sAICallback->Clb_UnitDef_isCanGuard(teamId, unitDefId);
unitDef->canBuild = sAICallback->Clb_UnitDef_isCanBuild(teamId, unitDefId);
unitDef->canAssist = sAICallback->Clb_UnitDef_isCanAssist(teamId, unitDefId);
unitDef->canBeAssisted = sAICallback->Clb_UnitDef_isCanBeAssisted(teamId, unitDefId);
unitDef->canRepeat = sAICallback->Clb_UnitDef_isCanRepeat(teamId, unitDefId);
unitDef->canFireControl = sAICallback->Clb_UnitDef_isCanFireControl(teamId, unitDefId);
...
unitDef->canCrash = sAICallback->Clb_UnitDef_isCanCrash(teamId, unitDefId);
...
unitDef->cantBeTransported = sAICallback->Clb_UnitDef_isCantBeTransported(teamId, unitDefId);
...
unitDef->canCloak = sAICallback->Clb_UnitDef_isCanCloak(teamId, unitDefId);
...
unitDef->canKamikaze = sAICallback->Clb_UnitDef_isCanKamikaze(teamId, unitDefId);
...
unitDef->canDGun = sAICallback->Clb_UnitDef_isCanDGun(teamId, unitDefId);
...
unitDef->canResurrect = sAICallback->Clb_UnitDef_isCanResurrect(teamId, unitDefId);
unitDef->canCapture = sAICallback->Clb_UnitDef_isCanCapture(teamId, unitDefId);
...
unitDef->canDropFlare = sAICallback->Clb_UnitDef_isCanDropFlare(teamId, unitDefId);
...
unitDef->stockpileWeaponDef = this->GetWeaponDefById(sAICallback->Clb_UnitDef_getStockpileWeaponDefId(teamId, unitDefId));
{
	...
	numBo = sAICallback->Clb_UnitDef_0ARRAY1VALS0getBuildOptions(teamId, unitDefId, bo, numBo);
...
bool CAIAICallback::CanBuildAt(const UnitDef* unitDef, float3 pos, int facing) {
	return sAICallback->Clb_Map_canBuildAt(teamId, unitDef->id, pos.toSAIFloat3(), facing);
}
...
weaponDef->canAttackGround = sAICallback->Clb_WeaponDef_isCanAttackGround(teamId, weaponDefId);
...
int CAIAICallback::CreateGroup(const char* libraryName, unsigned aiNumber) {
		SCreateGroupCommand cmd = {libraryName, aiNumber}; sAICallback->Clb_handleCommand(teamId, COMMAND_TO_ID_ENGINE, -1, COMMAND_GROUP_CREATE, &cmd); return cmd.ret_groupId;
}
