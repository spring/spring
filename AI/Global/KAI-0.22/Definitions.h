...
// Unit Categories
enum {CAT_COMM, CAT_ENERGY, CAT_MEX, CAT_MMAKER, CAT_BUILDER, CAT_ESTOR, CAT_MSTOR, CAT_FACTORY, CAT_DEFENCE, CAT_ATTACK, CAT_ARTILLERY, CAT_ASSAULT, CAT_A_ATTACK, CAT_TRANSPORT, CAT_A_TRANSPORT, CAT_RADAR, CAT_SONAR, CAT_R_JAMMER, CAT_S_JAMMER, CAT_LONG_RANGE_WEAPON, CAT_ANTIWEAPON, LASTCATEGORY};
