...
#define AAI_VERSION "0.70"
#define MAP_FILE_VERSION "MAP_LEARN_0_68"
#define TABLE_FILE_VERSION "MOD_LEARN_0_68"
...
enum UnitMoveType {GROUND, AIR, SEA, HOVER};
...
COMMANDER, GROUND_ASSAULT, AIR_ASSAULT, HOVER_ASSAULT, SEA_ASSAULT, SUBMARINE_ASSAULT, GROUND_SCOUT, AIR_SCOUT, HOVER_SCOUT, 
SEA_SCOUT, MOBILE_ARTY, MOBILE_JAMMER, MOBILE_LAUNCHER, GROUND_BUILDER, AIR_BUILDER, HOVER_BUILDER, SEA_BUILDER}; 
...
enum UnitTask {IDLE, ATTACKING, DEFENDING, BUILDING, SCOUTING, ASSISTING, RECLAIMING, UNIT_KILLED};
