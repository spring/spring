...
#ifndef _ROAM_SINGLE_MESH_DRAWER_H_
#define _ROAM_SINGLE_MESH_DRAWER_H_
 ...
 */
class CRoamSingleMeshDrawer : public IMeshDrawer, public CEventClient
{
public:
...
public:
	...
	CRoamSingleMeshDrawer(CSMFGroundDrawer* gd);
	~CRoamSingleMeshDrawer();
...
private:
	...
	bool Tessellate(std::vector<PatchSingle>& patches, const CCamera* cam, int viewRadius, bool shadowPass);
...
private:
	...
	std::vector< PatchSingle > patchMeshGrid[MESH_COUNT];
	std::vector< PatchSingle*> borderPatches[MESH_COUNT];
...
#endif // _ROAM_SINGLE_MESH_DRAWER_H_
