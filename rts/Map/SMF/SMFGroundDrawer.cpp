...
inline void CSMFGroundDrawer::DrawRoamMesh(bool inShadowPass, bool drawWaterReflection, bool drawUnitReflection)
{
...
#endif
		if (useROAM) {
			DrawRoamMesh(false, drawWaterReflection, drawUnitReflection);
		} else {
