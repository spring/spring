...
/* s_modfl.c -- Extended version of s_modf.c.
...
/*
 * modfl(Extended x, Extended *iptr)
...
#ifdef __STDC__
static const Extended one = 1.0l;
#else
static Extended one = 1.0l;
#endif

#ifdef __STDC__
	Extended __modfl(Extended x, Extended *iptr)
#else
	Extended __modfl(x, iptr)
	Extended x,*iptr;
#endif
{
	int32_t i0,i1,j0;
