...
class CEventHandler
{
	...
	public:
		...
		bool AllowUnitTransportLoad(const CUnit* transporter, const CUnit* transportee, bool allowed);
		bool AllowUnitTransportUnload(const CUnit* transporter, const CUnit* transportee, bool allowed);
