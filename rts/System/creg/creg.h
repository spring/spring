...
#define CR_BIND_TEMPLATE_1TYPED(TCls, TArg, ctor_args) \
	...
	template<typename TArg> creg::Class TCls<TArg>::creg_class(#TCls ## "<" ## #TArg ## ">", creg::CF_None, nullptr, &TCls<TArg>::_CregRegisterMembers, sizeof(TCls<TArg>), alignof(TCls<TArg>), std::is_polymorphic<TCls<TArg>>::value, TCls<TArg>::creg_isStruct, TCls<TArg>::_ConstructInstance, TCls<TArg>::_DestructInstance, nullptr, nullptr);
