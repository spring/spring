...
class CSyncDebugger {
	...
	private:
		...
		enum {
			MAX_STACK = 20,       ///< Maximum number of stackframes per HistItemWithBacktrace.
			BLOCK_SIZE = 1<<15,   ///< Number of \p HistItem per block history.
			HISTORY_SIZE = 1<<15, ///< Number of blocks of the entire history.
		};
