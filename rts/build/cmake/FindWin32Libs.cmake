...
ELSEIF(MINGW)
	...
	IF (NOT SHLWAPI_LIBRARY)
		FIND_LIBRARY(SHLWAPI_LIBRARY shlwapi PATHS ${WIN32_LIBRARY_SEARCHPATHS})
		IF (NOT SHLWAPI_LIBRARY)
			MESSAGE(SEND_ERROR "Could not find win32 SHLWAPI library.")
			SET(WIN32_FOUND FALSE)
		ENDIF(NOT WINMM_LIBRARY)
...
IF(WIN32_FOUND)
	SET(WIN32_LIBRARIES
		...
		${WINMM_LIBRARY}
		${SHLWAPI_LIBRARY}  # for System/FileSystem
	)
