...
private:
	...
	float ZoomIn(const float3& curCamPos, const float3& curCamDir, const float2& zoomParams);
	float ZoomOut(const float3& curCamPos, const float3& curCamDir, const float2& zoomParams);
