...
void CGame::RegisterUnsyncedActionExecutors()
{
	...
	RegisterUnsyncedActionExecutor(new SelectActionExecutor());
	RegisterUnsyncedActionExecutor(new SelectUnitsActionExecutor());
	RegisterUnsyncedActionExecutor(new SelectCycleActionExecutor());
	RegisterUnsyncedActionExecutor(new DeselectActionExecutor());
	RegisterUnsyncedActionExecutor(new ShadowsActionExecutor());
	RegisterUnsyncedActionExecutor(new WaterActionExecutor());
	RegisterUnsyncedActionExecutor(new AdvModelShadingActionExecutor());
	RegisterUnsyncedActionExecutor(new AdvMapShadingActionExecutor());
	RegisterUnsyncedActionExecutor(new SayActionExecutor());
	RegisterUnsyncedActionExecutor(new SayPrivateActionExecutor());
	RegisterUnsyncedActionExecutor(new SayPrivateByPlayerIDActionExecutor());
	RegisterUnsyncedActionExecutor(new EchoActionExecutor());
	RegisterUnsyncedActionExecutor(new SetActionExecutor());
	RegisterUnsyncedActionExecutor(new SetOverlayActionExecutor());
	RegisterUnsyncedActionExecutor(new EnableDrawInMapActionExecutor());
	RegisterUnsyncedActionExecutor(new DrawLabelActionExecutor());
	RegisterUnsyncedActionExecutor(new MouseActionExecutor(1));
	RegisterUnsyncedActionExecutor(new MouseActionExecutor(2));
	RegisterUnsyncedActionExecutor(new MouseActionExecutor(3));
	RegisterUnsyncedActionExecutor(new MouseActionExecutor(4));
	RegisterUnsyncedActionExecutor(new MouseActionExecutor(5));
	RegisterUnsyncedActionExecutor(new ViewSelectionActionExecutor());
	RegisterUnsyncedActionExecutor(new CameraMoveActionExecutor(0, "Forward"));
	RegisterUnsyncedActionExecutor(new CameraMoveActionExecutor(1, "Back"));
	RegisterUnsyncedActionExecutor(new CameraMoveActionExecutor(2, "Left"));
	RegisterUnsyncedActionExecutor(new CameraMoveActionExecutor(3, "Right"));
	RegisterUnsyncedActionExecutor(new CameraMoveActionExecutor(4, "Up"));
	RegisterUnsyncedActionExecutor(new CameraMoveActionExecutor(5, "Down"));
	RegisterUnsyncedActionExecutor(new CameraMoveActionExecutor(6, "Fast"));
	RegisterUnsyncedActionExecutor(new CameraMoveActionExecutor(7, "Slow"));
	RegisterUnsyncedActionExecutor(new AIKillReloadActionExecutor(true));
	RegisterUnsyncedActionExecutor(new AIKillReloadActionExecutor(false));
	RegisterUnsyncedActionExecutor(new AIControlActionExecutor());
	RegisterUnsyncedActionExecutor(new AIListActionExecutor());
	RegisterUnsyncedActionExecutor(new TeamActionExecutor());
	RegisterUnsyncedActionExecutor(new SpectatorActionExecutor());
	RegisterUnsyncedActionExecutor(new SpecTeamActionExecutor());
	RegisterUnsyncedActionExecutor(new SpecFullViewActionExecutor());
	RegisterUnsyncedActionExecutor(new AllyActionExecutor());
	RegisterUnsyncedActionExecutor(new GroupActionExecutor());
	RegisterUnsyncedActionExecutor(new GroupIDActionExecutor(0));
	RegisterUnsyncedActionExecutor(new GroupIDActionExecutor(1));
	RegisterUnsyncedActionExecutor(new unsyncedActionExecutors::GroupIDActionExecutor(2));
	RegisterUnsyncedActionExecutor(new GroupIDActionExecutor(3));
	RegisterUnsyncedActionExecutor(new GroupIDActionExecutor(4));
	RegisterUnsyncedActionExecutor(new GroupIDActionExecutor(5));
	RegisterUnsyncedActionExecutor(new GroupIDActionExecutor(6));
	RegisterUnsyncedActionExecutor(new GroupIDActionExecutor(7));
	RegisterUnsyncedActionExecutor(new GroupIDActionExecutor(8));
	RegisterUnsyncedActionExecutor(new GroupIDActionExecutor(9));
	RegisterUnsyncedActionExecutor(new LastMessagePositionActionExecutor());

	// chat command variants
	RegisterUnsyncedActionExecutor(new ChatActionExecutor("Chat",     "",   false));
	RegisterUnsyncedActionExecutor(new ChatActionExecutor("ChatAll",  "",   true));
	RegisterUnsyncedActionExecutor(new ChatActionExecutor("ChatAlly", "a:", true));
	RegisterUnsyncedActionExecutor(new ChatActionExecutor("ChatSpec", "s:", true));

	RegisterUnsyncedActionExecutor(new TrackActionExecutor());
	RegisterUnsyncedActionExecutor(new TrackOffActionExecutor());
	RegisterUnsyncedActionExecutor(new TrackModeActionExecutor());
#ifdef USE_GML
	RegisterUnsyncedActionExecutor(new ShowHealthBarsActionExecutor());
	RegisterUnsyncedActionExecutor(new ShowRezurectionBarsActionExecutor());
#endif // USE_GML
	RegisterUnsyncedActionExecutor(new PauseActionExecutor());
	RegisterUnsyncedActionExecutor(new DebugActionExecutor());
	RegisterUnsyncedActionExecutor(new NoSoundActionExecutor());
	RegisterUnsyncedActionExecutor(new SoundChannelEnableActionExecutor());
	RegisterUnsyncedActionExecutor(new CreateVideoActionExecutor());
	RegisterUnsyncedActionExecutor(new DrawTreesActionExecutor());
	RegisterUnsyncedActionExecutor(new DynamicSkyActionExecutor());
	RegisterUnsyncedActionExecutor(new DynamicSunActionExecutor());
#ifdef USE_GML
	RegisterUnsyncedActionExecutor(new MultiThreadDrawGroundActionExecutor());
	RegisterUnsyncedActionExecutor(new MultiThreadDrawGroundShadowActionExecutor());
	RegisterUnsyncedActionExecutor(new MultiThreadDrawUnitActionExecutor());
	RegisterUnsyncedActionExecutor(new MultiThreadDrawUnitShadowActionExecutor());
	RegisterUnsyncedActionExecutor(new MultiThreadDrawActionExecutor());
	RegisterUnsyncedActionExecutor(new MultiThreadSimActionExecutor());
	RegisterUnsyncedActionExecutor(new MultiThreadActionExecutor());
#endif // USE_GML
	RegisterUnsyncedActionExecutor(new SpeedControlActionExecutor());
	RegisterUnsyncedActionExecutor(new GameInfoActionExecutor());
	RegisterUnsyncedActionExecutor(new HideInterfaceActionExecutor());
	RegisterUnsyncedActionExecutor(new HardwareCursorActionExecutor());
	RegisterUnsyncedActionExecutor(new IncreaseViewRadiusActionExecutor());
	RegisterUnsyncedActionExecutor(new DecreaseViewRadiusActionExecutor());
	RegisterUnsyncedActionExecutor(new MoreTreesActionExecutor());
	RegisterUnsyncedActionExecutor(new LessTreesActionExecutor());
	RegisterUnsyncedActionExecutor(new MoreCloudsActionExecutor());
	RegisterUnsyncedActionExecutor(new LessCloudsActionExecutor());
	RegisterUnsyncedActionExecutor(new SpeedUpActionExecutor());
	RegisterUnsyncedActionExecutor(new SlowDownActionExecutor());
	RegisterUnsyncedActionExecutor(new ControlUnitActionExecutor());
	RegisterUnsyncedActionExecutor(new ShowStandardActionExecutor());
	RegisterUnsyncedActionExecutor(new ShowElevationActionExecutor());
	RegisterUnsyncedActionExecutor(new ToggleRadarAndJammerActionExecutor());
	RegisterUnsyncedActionExecutor(new ShowMetalMapActionExecutor());
	RegisterUnsyncedActionExecutor(new ShowPathTraversabilityActionExecutor());
	RegisterUnsyncedActionExecutor(new ShowPathHeatActionExecutor());
	RegisterUnsyncedActionExecutor(new ShowPathCostActionExecutor());
	RegisterUnsyncedActionExecutor(new ToggleLOSActionExecutor());
	RegisterUnsyncedActionExecutor(new ShareDialogActionExecutor());
	RegisterUnsyncedActionExecutor(new QuitMessageActionExecutor());
	RegisterUnsyncedActionExecutor(new QuitMenuActionExecutor());
	RegisterUnsyncedActionExecutor(new QuitActionExecutor());
	RegisterUnsyncedActionExecutor(new AliasActionExecutor(new QuitActionExecutor(), "QuitForce"));
	RegisterUnsyncedActionExecutor(new IncreaseGUIOpacityActionExecutor());
	RegisterUnsyncedActionExecutor(new DecreaseGUIOpacityActionExecutor());
	RegisterUnsyncedActionExecutor(new ScreenShotActionExecutor());
	RegisterUnsyncedActionExecutor(new GrabInputActionExecutor());
	RegisterUnsyncedActionExecutor(new ClockActionExecutor());
	RegisterUnsyncedActionExecutor(new CrossActionExecutor());
	RegisterUnsyncedActionExecutor(new FPSActionExecutor());
	RegisterUnsyncedActionExecutor(new SpeedActionExecutor());
	RegisterUnsyncedActionExecutor(new MTInfoActionExecutor());
	RegisterUnsyncedActionExecutor(new TeamHighlightActionExecutor());
	RegisterUnsyncedActionExecutor(new InfoActionExecutor());
	RegisterUnsyncedActionExecutor(new CmdColorsActionExecutor());
	RegisterUnsyncedActionExecutor(new CtrlPanelActionExecutor());
	RegisterUnsyncedActionExecutor(new FontActionExecutor());
	RegisterUnsyncedActionExecutor(new VSyncActionExecutor());
	RegisterUnsyncedActionExecutor(new SafeGLActionExecutor());
	RegisterUnsyncedActionExecutor(new ResBarActionExecutor());
	RegisterUnsyncedActionExecutor(new ToolTipActionExecutor());
	RegisterUnsyncedActionExecutor(new ConsoleActionExecutor());
	RegisterUnsyncedActionExecutor(new EndGraphActionExecutor());
	RegisterUnsyncedActionExecutor(new FPSHudActionExecutor());
	RegisterUnsyncedActionExecutor(new DebugDrawAIActionExecutor());
	RegisterUnsyncedActionExecutor(new MapMarksActionExecutor());
	RegisterUnsyncedActionExecutor(new AllMapMarksActionExecutor());
	RegisterUnsyncedActionExecutor(new ClearMapMarksActionExecutor());
	RegisterUnsyncedActionExecutor(new NoLuaDrawActionExecutor());
	RegisterUnsyncedActionExecutor(new LuaUIActionExecutor());
	RegisterUnsyncedActionExecutor(new LuaModUICtrlActionExecutor());
	RegisterUnsyncedActionExecutor(new MiniMapActionExecutor());
	RegisterUnsyncedActionExecutor(new GroundDecalsActionExecutor());
	RegisterUnsyncedActionExecutor(new MaxParticlesActionExecutor());
	RegisterUnsyncedActionExecutor(new MaxNanoParticlesActionExecutor());
	RegisterUnsyncedActionExecutor(new GatherModeActionExecutor());
	RegisterUnsyncedActionExecutor(new PasteTextActionExecutor());
	RegisterUnsyncedActionExecutor(new BufferTextActionExecutor());
	RegisterUnsyncedActionExecutor(new InputTextGeoActionExecutor());
	RegisterUnsyncedActionExecutor(new DistIconActionExecutor());
	RegisterUnsyncedActionExecutor(new DistDrawActionExecutor());
	RegisterUnsyncedActionExecutor(new LODScaleActionExecutor());
	RegisterUnsyncedActionExecutor(new WireMapActionExecutor());
	RegisterUnsyncedActionExecutor(new AirMeshActionExecutor());
	RegisterUnsyncedActionExecutor(new SetGammaActionExecutor());
	RegisterUnsyncedActionExecutor(new CrashActionExecutor());
	RegisterUnsyncedActionExecutor(new ExceptionActionExecutor());
	RegisterUnsyncedActionExecutor(new DivByZeroActionExecutor());
	RegisterUnsyncedActionExecutor(new GiveActionExecutor());
	RegisterUnsyncedActionExecutor(new DestroyActionExecutor());
	RegisterUnsyncedActionExecutor(new SendActionExecutor());
	RegisterUnsyncedActionExecutor(new SaveGameActionExecutor());
	RegisterUnsyncedActionExecutor(new SaveActionExecutor());
	RegisterUnsyncedActionExecutor(new ReloadGameActionExecutor());
	RegisterUnsyncedActionExecutor(new DebugInfoActionExecutor());
	RegisterUnsyncedActionExecutor(new BenchmarkScriptActionExecutor());
	// XXX are these redirects really required?
	RegisterUnsyncedActionExecutor(new RedirectToSyncedActionExecutor("ATM"));
#ifdef DEBUG
	RegisterUnsyncedActionExecutor(new RedirectToSyncedActionExecutor("Desync"));
#endif
	RegisterUnsyncedActionExecutor(new RedirectToSyncedActionExecutor("Resync"));
	RegisterUnsyncedActionExecutor(new RedirectToSyncedActionExecutor("Take"));
	RegisterUnsyncedActionExecutor(new RedirectToSyncedActionExecutor("LuaRules"));
	RegisterUnsyncedActionExecutor(new RedirectToSyncedActionExecutor("LuaGaia"));
}
