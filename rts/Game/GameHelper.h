...
public:
	...
	void Explosion(float3 pos,const DamageArray& damages,float radius, float edgeEffectivness, float explosionSpeed, CUnit* owner,bool damageGround=true,float gfxMod=1,bool ignoreOwner=false, CExplosionGenerator *explosionGraphics=0);
