...
void CBeamLaser::Fire(void)
{
	...
	if(curLength<maxLength)
		helper->Explosion(hitPos,damages*intensity,areaOfEffect,weaponDef->edgeEffectivness,weaponDef->explosionSpeed,owner, true, 1.0f, false,weaponDef->explosionGenerator,hit,dir);
}
