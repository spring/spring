...
WEAPONDUMMYTAG(int, shieldArmorType).externalName("shield.armorType").fallbackName("shieldArmorType")
	.defaultValue("default").description("The armor type of the shield");
