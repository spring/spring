...
void CLaserCannon::Fire(void)
{
	...
	new CLaserProjectile(weaponPos, dir*projectileSpeed, owner, weaponDef->damages, weaponDef->beamlength, weaponDef->visuals.color, weaponDef->visuals.color2, weaponDef->intensity, weaponDef, (int)((weaponDef->range-fpsSub*4)/weaponDef->projectilespeed)-fpsSub);
