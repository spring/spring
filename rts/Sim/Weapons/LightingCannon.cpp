...
//		u->DoDamage(damages,owner,ZeroVector);
	helper->Explosion(weaponPos+dir*r,damages,areaOfEffect,weaponDef->edgeEffectivness,weaponDef->explosionSpeed,owner,false,0.5f,true,weaponDef->explosionGenerator, u,dir);
