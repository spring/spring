...
enum { MT_LUA_FIRST = 0, MT_LUA_DEFAULT = 0, MT_LUA_NONE = 0, MT_LUA_FIRSTACTIVE = 1, MT_LUA_SINGLE = 1, MT_LUA_SINGLE_BATCH,
		MT_LUA_DUAL_EXPORT, MT_LUA_DUAL, MT_LUA_DUAL_ALL, MT_LUA_SIZE, MT_LUA_LAST = MT_LUA_SIZE - 1 };
