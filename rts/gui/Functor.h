...
public:
	...
	friend RHCB_BOOL
		operator==(const FunctorBase &lhs,const FunctorBase &rhs);
	friend RHCB_BOOL
		operator!=(const FunctorBase &lhs,const FunctorBase &rhs);
	friend RHCB_BOOL
		operator<(const FunctorBase &lhs,const FunctorBase &rhs);
   ...
   //The rest below for implementation use only !
	...
	typedef void (*PFunc)();
	#if defined MWCC || defined GCC || defined(__GNUC__)
...
makeFunctor(Functor0 *,Callee &c,TRT (CallType::* RHCB_CONST_REF f)())
	{
...
makeFunctor(Functor0 *,const Callee &c,
...
public:
	CBFunctionTranslator0wRet(Func f):Functor0wRet<RT>(thunk,0,f,0,0){}
	static RT thunk(const FunctorBase &ftor)
		{
...
makeFunctor(Functor0wRet<RT>*,Callee &c,TRT (CallType::* RHCB_CONST_REF f)())
	{
	typedef TRT (CallType::*MemFunc)();
...
public:
	CBFunctionTranslator1(Func f):Functor1<P1>(thunk,0,f,0,0){}
	static void thunk(const FunctorBase &ftor,P1 p1)
		{
...
makeFunctor(Functor1<P1>*,Callee &c,TRT (CallType::* RHCB_CONST_REF f)(TP1))
	{
...
makeFunctor(Functor1<P1>*,TRT (CallType::* RHCB_CONST_REF f)())
	{
	typedef TRT (CallType::*MemFunc)();
...
makeFunctor(Functor1<P1>*,TRT (CallType::* RHCB_CONST_REF f)()const)
	{
	typedef TRT (CallType::*MemFunc)()const;
	return CBMemberOf1stArgTranslator1<P1,MemFunc>(f);
	}
...
public:
	CBFunctionTranslator1wRet(Func f):
		Functor1wRet<P1,RT>(thunk,0,f,0,0){}
	static RT thunk(const FunctorBase &ftor,P1 p1)
		{
...
makeFunctor(Functor1wRet<P1,RT>*,TRT (CallType::* RHCB_CONST_REF f)())
	{
	typedef TRT (CallType::*MemFunc)();
...
makeFunctor(Functor1wRet<P1,RT>*,TRT (CallType::* RHCB_CONST_REF f)()const)
	{
	typedef TRT (CallType::*MemFunc)()const;
	return CBMemberOf1stArgTranslator1wRet<P1,RT,MemFunc>(f);
	}
...
public:
	CBFunctionTranslator2(Func f):Functor2<P1,P2>(thunk,0,f,0,0){}
	static void thunk(const FunctorBase &ftor,P1 p1,P2 p2)
		{
...
makeFunctor(Functor2<P1,P2>*,Callee &c,
...
makeFunctor(Functor2<P1,P2>*,TRT (CallType::* RHCB_CONST_REF f)(TP1))
	{
	typedef TRT (CallType::*MemFunc)(TP1);
...
makeFunctor(Functor2<P1,P2>*,TRT (CallType::* RHCB_CONST_REF f)(TP1)const)
	{
	typedef TRT (CallType::*MemFunc)(TP1)const;
	return CBMemberOf1stArgTranslator2<P1,P2,MemFunc>(f);
	}
...
public:
	CBFunctionTranslator2wRet(Func f):
		Functor2wRet<P1,P2,RT>(thunk,0,f,0,0){}
	static RT thunk(const FunctorBase &ftor,P1 p1,P2 p2)
		{
...
makeFunctor(Functor2wRet<P1,P2,RT>*,TRT (CallType::* RHCB_CONST_REF f)(TP1))
	{
	typedef TRT (CallType::*MemFunc)(TP1);
...
public:
	CBFunctionTranslator3(Func f):Functor3<P1,P2,P3>(thunk,0,f,0,0){}
	static void thunk(const FunctorBase &ftor,P1 p1,P2 p2,P3 p3)
		{
...
makeFunctor(Functor3<P1,P2,P3>*,TRT (CallType::* RHCB_CONST_REF f)(TP1,TP2))
	{
	typedef TRT (CallType::*MemFunc)(TP1,TP2);
...
public:
	CBFunctionTranslator3wRet(Func f):
		Functor3wRet<P1,P2,P3,RT>(thunk,0,f,0,0){}
	static RT thunk(const FunctorBase &ftor,P1 p1,P2 p2,P3 p3)
		{
...
public:
	CBFunctionTranslator4(Func f):
		Functor4<P1,P2,P3,P4>(thunk,0,f,0,0){}
	static void thunk(const FunctorBase &ftor,P1 p1,P2 p2,P3 p3,P4 p4)
		{
...
public:
	CBFunctionTranslator4wRet(Func f):
		Functor4wRet<P1,P2,P3,P4,RT>(thunk,0,f,0,0){}
	static RT thunk(const FunctorBase &ftor,P1 p1,P2 p2,P3 p3,P4 p4)
		{
