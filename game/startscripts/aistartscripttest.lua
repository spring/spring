...
function MissionTest:Setup()
    ...
    units.Load("ARMFAV", float3(300, 80, 300), 0, false)
    units.Load("ARMFAV", float3(340, 80, 300), 0, false)
    units.Load("ARMFAV", float3(380, 80, 300), 0, false)
    units.Load("ARMFAV", float3(420, 80, 300), 0, false)

    units.Load("ARMFAV", float3(1200, 80, 200), 1, false)
    units.Load("ARMFAV", float3(1200, 80, 240), 1, false)
    units.Load("ARMFAV", float3(1200, 80, 280), 1, false)
    units.Load("ARMFAV", float3(1200, 80, 320), 1, false)

    units.Load("ARMMAV", float3(300, 80, 300), 0, false)
    units.Load("ARMZEUS", float3(460, 80, 300), 0, false)
