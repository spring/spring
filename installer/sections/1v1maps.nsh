!ifdef INSTALL
  ...
  inetc::get \
             "http://buildbot.no-ip.org/~lordmatt/maps/1v1maps/4886_Lowland_Crossing_TNM01-V4.sd7" "$INSTDIR\maps\4886_Lowland_Crossing_TNM01-V4.sd7" \
	     "http://buildbot.no-ip.org/~lordmatt/maps/1v1maps/8862_Cooper_Hill_TNM02-V1.sd7" "$INSTDIR\maps\8862_Cooper_Hill_TNM02-V1.sd7" \
	     "http://buildbot.no-ip.org/~lordmatt/maps/1v1maps/Altair_Crossing.sd7" "$INSTDIR\maps\Altair_Crossing.sd7" \
	     ...
	     "http://buildbot.no-ip.org/~lordmatt/maps/1v1maps/DarkSide_Remake.sd7" "$INSTDIR\maps\DarkSide_Remake.sd7" \
	     "http://buildbot.no-ip.org/~lordmatt/maps/1v1maps/Geyser_Plains_TNM04-V3.sd7" "$INSTDIR\maps\Geyser_Plains_TNM04-V3.sd7" \
	     "http://buildbot.no-ip.org/~lordmatt/maps/1v1maps/HundredsIsles.sd7" "$INSTDIR\maps\HundredsIsles.sd7" \
	     "http://buildbot.no-ip.org/~lordmatt/maps/1v1maps/Mars.sd7" "$INSTDIR\maps\Mars.sd7" \
	     "http://buildbot.no-ip.org/~lordmatt/maps/1v1maps/MoonQ10x.sd7" "$INSTDIR\maps\MoonQ10x.sd7" 
