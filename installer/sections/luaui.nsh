!ifdef INSTALL
  ...
  File "${DIST_DIR}\LuaUI\Icons\chi.png"
  ...
  File "${DIST_DIR}\LuaUI\Widgets\gui_buildspacing.lua"
  ...
  File "${DIST_DIR}\LuaUI\Images\flags25x15.png"
